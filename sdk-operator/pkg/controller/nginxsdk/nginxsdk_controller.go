...
func (r *ReconcileNginxSDK) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	if err != nil && errors.IsNotFound(err) {
		...
		found.Spec.Template.Spec.Containers[0].Env[0].Value = instance.Spec.DefaultBody
                ...
                if len(found.Spec.Template.Spec.Containers[0].Env) == 1{ 
                      found.Spec.Template.Spec.Containers[0].Env = append(found.Spec.Template.Spec.Containers[0].Env,deploy.Spec.Template.Spec.Containers[0].Env[1])
                }
